...
<script>
function s() {
    var url_template = "http://gw.open.1688.com/auth/authorize.htm?client_id=1006478&site=china&redirect_uri=<?php echo(Config::get('redirect_uri')); ?>&state=YOUR_PARM&_aop_signature=DC667B0B8D0A5ADA0A43877803CCC3292CF1521A",
    url = url_template.replace('YOUR_PARM', document.mainform.id.value);
